...
const Course = ({course}) => {
    return (
        <Link to={`/course-detail/${course._id}`}>
            <Card className="overflow-hidden rounded-lg dark:bg-gray-800 bg-white shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300">
...
//           React Basic to Advance in Hindi
//         </h1>
//         <div className="flex items-center justify-between">
//           <div className="flex items-center gap-3">
//             <Avatar className="h-8 w-8">
...
//               <AvatarFallback>CN</AvatarFallback>
//             </Avatar>
//             <h1 className="font-medium text-sm">Suraj React</h1>
//           </div>
//           <Badge className={'bg-blue-600 text-white px-2 py-1 text-xs rounded-full'}>
//             Advance
//           </Badge>
